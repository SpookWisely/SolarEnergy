...
def decisionTreeModelDS(mergedDs: pd.DataFrame, plots:bool,features:bool):
    ...
    feature_cols = [
        "ALLSKY_SFC_SW_DWN_S", "ALLSKY_SFC_UV_INDEX_S", "ALLSKY_KT_S",
        "CLRSKY_SFC_PAR_TOT_S","RH2M_S","PSC_S", "hour", "day", "month"
    ]
...
def randomForestModelDS(mergedDs: pd.DataFrame, plots:bool,features:bool):
    ...
    feature_cols = [
        "ALLSKY_SFC_SW_DWN_S", "T2M_S", "ALLSKY_KT_S",
        "CLRSKY_SFC_PAR_TOT_S", "PSC_S", 
        "PSC_D", "hour", "day", "month"
    ]
...
def xgbModelDS(mergedDs: pd.DataFrame, plots:bool,features:bool):
    ...
    feature_cols = [
        "ALLSKY_SFC_SW_DWN_S", "T2M_S","ALLSKY_KT_S",
        "CLRSKY_SFC_PAR_TOT_S","PSC_D", "hour", "day", "month"
    ]
...
def biDirectionalLSTMDS(mergedDs: pd.DataFrame, plots:bool,features:bool):
    ...
    feature_cols = [
        "ALLSKY_SFC_SW_DWN_S", "T2M_S", "ALLSKY_KT_S",
        "CLRSKY_SFC_PAR_TOT_S","CLRSKY_SFC_PAR_TOT_D", "T2M_D", "hour", "day", "month"
    ]
...
def GRUModelDS(mergedDs: pd.DataFrame, plots:bool,features:bool):
    ...
    feature_cols = [
        "ALLSKY_SFC_SW_DWN_S","T2M_S","ALLSKY_KT_S",
        "CLRSKY_SFC_PAR_TOT_S","CLRSKY_SFC_PAR_TOT_D","PSC_D","hour", "day", "month"
    ]
...
def MLPModelDS(mergedDs: pd.DataFrame, plots:bool,features:bool):
    ...
    feature_cols = [
        "ALLSKY_SFC_SW_DWN_S", "T2M_S",
        "CLRSKY_SFC_PAR_TOT_S","ALLSKY_SFC_SW_DWN_D","T2M_D","PSC_D","hour", "day", "month"
    ]
...
def CNNModelDS(mergedDs: pd.DataFrame, plots:bool,features:bool):
    ...
    feature_cols = [
        "ALLSKY_SFC_SW_DWN_S", "T2M_S", "ALLSKY_KT_S",
        "CLRSKY_SFC_PAR_TOT_S","T2M_D","PS_D", "hour", "day", "month"
    ]
...
def NSGA3_CNN_ModelDS(
    ...
    feature_cols = [
        "ALLSKY_SFC_SW_DWN_S","T2M_S","ALLSKY_KT_S",
        "CLRSKY_SFC_PAR_TOT_S","PSC_D","T2M_D","hour", "day", "month"
    ]
    target_cols = ['Demand_MW', 'Supply_MW']
...
"""
modelresults = [DecTree, randForest, xgb, gbdt, blstm, lstm, gru, svr,mlp 
#cnn, nsga2cnn, nsga3cnn
]
