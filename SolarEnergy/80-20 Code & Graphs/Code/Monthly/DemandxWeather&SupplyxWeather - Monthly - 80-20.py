...
sp_WeatherSu = pd.read_excel(r"C:\Users\Harry\source\repos\SolarEnergy\SolarEnergy\Datasets\weather for solar 2021.xlsx")
...
def biDirectionalLSTMDS(demandDs:pd.DataFrame,supplyDs:pd.DataFrame,ident:int):
    ...
    ##Basic transformation for the base dataset
        ...
        X_train, X_test, y_train, y_test = train_test_split(
            X_seq_scaled, y_seq_scaled, test_size=0.2, shuffle=False
        )
