...
dem_TREE = decisionTreeModelDS(sp_WeatherxDem,sp_WeatherxSup,1,False)
dem_RF = randomForestModelDS(sp_WeatherxDem,sp_WeatherxSup,1,False)
dem_XGB = xgbModelDS(sp_WeatherxDem,sp_WeatherxSup,1,False)
dem_GB =gbModelDS(sp_WeatherxDem,sp_WeatherxSup,1,False)
dem_BLSTM = biDirectionalLSTMDS(sp_WeatherxDem,sp_WeatherxSup,1,False)
dem_LSTM = LSTMModelDS(sp_WeatherxDem,sp_WeatherxSup,1,False)
dem_GRU = GRUModelDS(sp_WeatherxDem,sp_WeatherxSup,1,False)
dem_SVR = SVRModelDS(sp_WeatherxDem,sp_WeatherxSup,1,False)
dem_MLP = MLPModelDS(sp_WeatherxDem,sp_WeatherxSup,1,True)


dem_CNN = CNNModelDS(sp_WeatherxDem,sp_WeatherxSup,1,True)
dem_GBDT = GBDTModelDS(sp_WeatherxDem,sp_WeatherxSup,1,True)
...
sup_TREE = decisionTreeModelDS(sp_WeatherxDem,sp_WeatherxSup,2,True)
sup_RF = randomForestModelDS(sp_WeatherxDem,sp_WeatherxSup,2,True)
sup_XGB = xgbModelDS(sp_WeatherxDem,sp_WeatherxSup,2,True)
sup_GB =gbModelDS(sp_WeatherxDem,sp_WeatherxSup,2,True)
sup_BLSTM = biDirectionalLSTMDS(sp_WeatherxDem,sp_WeatherxSup,2,True)
sup_LSTM = LSTMModelDS(sp_WeatherxDem,sp_WeatherxSup,2,True)
sup_GRU = GRUModelDS(sp_WeatherxDem,sp_WeatherxSup,2,True)
sup_SVR = SVRModelDS(sp_WeatherxDem,sp_WeatherxSup,2,True)
sup_MLP = MLPModelDS(sp_WeatherxDem,sp_WeatherxSup,2,True)

sup_CNN = CNNModelDS(sp_WeatherxDem,sp_WeatherxSup,2,True)
sup_GBDT = GBDTModelDS(sp_WeatherxDem,sp_WeatherxSup,2,True)
