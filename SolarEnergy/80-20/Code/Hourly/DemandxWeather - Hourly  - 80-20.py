...
##------Demand Functions------
"""
dem_TREE = decisionTreeModelDS(sp_WeatherxDem,sp_WeatherxSup,1,True)
dem_RF = randomForestModelDS(sp_WeatherxDem,sp_WeatherxSup,1,True)
dem_XGB = xgbModelDS(sp_WeatherxDem,sp_WeatherxSup,1,True)
dem_GB =gbModelDS(sp_WeatherxDem,sp_WeatherxSup,1,True)
dem_BLSTM = biDirectionalLSTMDS(sp_WeatherxDem,sp_WeatherxSup,1,True)
dem_LSTM = LSTMModelDS(sp_WeatherxDem,sp_WeatherxSup,1,True)
dem_GRU = GRUModelDS(sp_WeatherxDem,sp_WeatherxSup,1,True)
dem_SVR = SVRModelDS(sp_WeatherxDem,sp_WeatherxSup,1,True)
