...
dem_TREE = decisionTreeModelDS(sp_DemandDef, sp_SupplyDef, 1)
dem_RF = randomForestModelDS(sp_DemandDef, sp_SupplyDef, 1)
dem_XGB = xgbModelDS(sp_DemandDef, sp_SupplyDef, 1)
dem_GB = gbModelDS(sp_DemandDef, sp_SupplyDef, 1)
dem_BLSTM = biDirectionalLSTMDS(sp_DemandDef, sp_SupplyDef, 1)
dem_LSTM = LSTMModelDS(sp_DemandDef, sp_SupplyDef, 1)
dem_GRU = GRUModelDS(sp_DemandDef, sp_SupplyDef, 1)
dem_SVR = SVRModelDS(sp_DemandDef, sp_SupplyDef, 1)
dem_MLP = MLPModelDS(sp_DemandDef, sp_SupplyDef, 1)
dem_CNN = CNNModelDS(sp_DemandDef, sp_SupplyDef, 1)
dem_GBDT = GBDTModelDS(sp_DemandDef, sp_SupplyDef, 1)
...
sup_TREE = decisionTreeModelDS(sp_DemandDef, sp_SupplyDef, 2)
sup_RF = randomForestModelDS(sp_DemandDef, sp_SupplyDef, 2)
sup_XGB = xgbModelDS(sp_DemandDef, sp_SupplyDef, 2)
sup_GB = gbModelDS(sp_DemandDef, sp_SupplyDef, 2)
sup_BLSTM = biDirectionalLSTMDS(sp_DemandDef, sp_SupplyDef, 2)
sup_LSTM = LSTMModelDS(sp_DemandDef, sp_SupplyDef, 2)
sup_GRU = GRUModelDS(sp_DemandDef, sp_SupplyDef, 2)
sup_SVR = SVRModelDS(sp_DemandDef, sp_SupplyDef, 2)
sup_MLP = MLPModelDS(sp_DemandDef, sp_SupplyDef, 2)
sup_CNN = CNNModelDS(sp_DemandDef, sp_SupplyDef, 2)
sup_GBDT = GBDTModelDS(sp_DemandDef, sp_SupplyDef, 2)
